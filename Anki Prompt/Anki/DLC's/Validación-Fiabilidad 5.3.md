...
1. Tabla Markdown con banco generado (columnas: Nº, Pregunta, Opción 1, Opción 2, Opción 3, Answer, Nota, Bloom, Confianza)
2. Informe técnico del generador (recomendado, mejora diagnóstico)
3. Bloom target configurado (ej: "Recordar 40%, Comprender 30%, Aplicar 30%")
